...
import net.sourceforge.opencamera.usb.event.MessageEvent;
import net.sourceforge.opencamera.usb.event.ScanResultMessageEvent;
import net.sourceforge.opencamera.usb.helper.SimpleDividerItemDecoration;
import net.sourceforge.opencamera.usb.listener.OnScanResultItemClickListener;
import net.sourceforge.opencamera.usb.presenter.ScanResultPresenter;
...
import static net.sourceforge.opencamera.usb.bean.Constants.EXTRA_KEY_PRODUCT_ID;
import static net.sourceforge.opencamera.usb.bean.Constants.EXTRA_KEY_VENDOR_ID;
