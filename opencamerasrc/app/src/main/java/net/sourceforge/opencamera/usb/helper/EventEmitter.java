package net.sourceforge.opencamera.usb.helper;

import android.graphics.Bitmap;


import net.sourceforge.opencamera.usb.asynctask.ReadUsbSingleFrameTask;
import net.sourceforge.opencamera.usb.bean.CameraDevice;
import net.sourceforge.opencamera.usb.bean.CameraHandler;
import net.sourceforge.opencamera.usb.event.CameraViewportMessageEvent;
